...
export default function ToutorMessages() {
    ...
    return (
        <div className="h-full flex flex-col -mx-4 md:-mx-6 lg:-mx-8">
            ...
            <div className="hidden md:flex bg-white border-b border-gray-200 px-6 py-3 mx-8 items-center justify-between shrink-0">
                <div>
                    <h2 className="text-xl font-bold bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent">
                        Messages
                    </h2>
                    <p className="text-gray-500 text-sm">
                        Communicate with your students and stay connected.
                    </p>
                </div>
            </div>

            <div className="flex-1 flex overflow-hidden bg-white rounded-b-2xl mx-8">
